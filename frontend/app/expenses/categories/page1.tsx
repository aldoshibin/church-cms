...
import { Plus, Edit2, Trash2, Tag, RefreshCw, Receipt } from 'lucide-react';
    ...
    <DashboardLayout title="Expense Categories" subtitle="Manage expense categories">
      <div className="flex justify-between items-center mb-6">
        <div>
          ...
          <p className="text-gray-500 text-sm mt-1">{types.length} categories defined</p>
        </div>
            ...
            {loading ? (
              ...
              <tr><td colSpan={5} className="text-center py-16">
                <div className="flex flex-col items-center gap-2 text-gray-400">
                  ...
                  <p className="font-medium text-gray-500">No expense categories yet</p>
