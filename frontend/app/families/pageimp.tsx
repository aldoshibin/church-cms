...
import {
  ...
  ChevronDown, ChevronRight, Users, Mail, RefreshCw
} from 'lucide-react';
      ...
      <div className="flex justify-between items-center mb-6">
        ...
        <div className="flex gap-2">
          <button onClick={fetchData}
            className="flex items-center gap-2 border border-gray-200 text-gray-600 px-3 py-2  text-sm hover:bg-gray-50 transition-colors">
            ...
            <thead style={{ background: '#f8fafc' }}>
              <tr>
                ...
                {['Family ID', 'Family Name', 'Email', 'Phone', 'City / State', 'Members', 'Actions'].map(h => (
                  <th key={h} className="text-left px-4 py-3 text-xs font-bold uppercase tracking-wider whitespace-nowrap" style={{ color: '#455a64' }}>{h}</th>
                ))}
              </tr>
            </thead>
                  ...
                  <React.Fragment key={fam.id}>
                    <tr className="hover:bg-gray-50 transition-colors">
                      ...
                      <td className="px-4 py-3">
                        <span className="inline-flex items-center px-2.5 py-1 bg-primary text-white rounded-lg text-xs font-bold tracking-widest font-mono">
                          {fam.family_id || '—'}
                        </span>
                      </td>
                      {/* Name */}
                      <td className="px-4 py-3">
                        <div className="flex items-center gap-2">
                          <div className="w-8 h-8 bg-indigo-100 text-primary rounded-full flex items-center justify-center shrink-0">
                            <Home size={13} />
                          </div>
                          <p className="text-sm font-semibold text-tbtext whitespace-nowrap">{fam.name}</p>
                        </div>
                      </td>
                      <td className="px-4 py-3 text-sm text-tbtext ">{fam.email || '—'}</td>
                      <td className="px-4 py-3 text-sm text-tbtext  whitespace-nowrap">{fam.phone || '—'}</td>
                      <td className="px-4 py-3 text-sm text-tbtext whitespace-nowrap">
                        ...
                        <td colSpan={8} className="p-0">
                          <div className="bg-indigo-50/50 border-y border-indigo-100 px-8 py-4">
                            <div className="flex items-center justify-between mb-3">
                              ...
                              <button onClick={() => router.push(`/families/${fam.id}/edit`)}
