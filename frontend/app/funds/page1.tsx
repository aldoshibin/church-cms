    ...
    <DashboardLayout title="Funds Management" subtitle="Manage church giving funds">
      ...
      <div className="flex justify-between items-center mb-6">
        <div>
          ...
          <p className="text-gray-500 text-sm mt-1">{funds.length} funds — {activeFunds} active</p>
        </div>
      ...
      {loading ? (
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-4">
          {funds.map(fund => {
            ...
            return (
              <div key={fund.id}
                className={`bg-white rounded-xl border border-gray-200 p-5 hover:shadow-sm transition-shadow ${!fund.is_active ? 'opacity-60' : ''}`}>
