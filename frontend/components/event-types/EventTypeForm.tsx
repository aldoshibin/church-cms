...
interface Props {
  typeId?: number;
  /** which API to use — keeps Service Types and Special Event Types sharing one form */
  api: {
  ...
  backPath: string;
  entityLabel: string; // "Service Type" | "Special Event Type"
}

export default function EventTypeForm({ typeId, api, backPath, entityLabel }: Props) {
        ...
        <div className="p-6 grid grid-cols-2 gap-5">
          <div className="col-span-2">
            ...
            <input
              ...
              required
              placeholder="e.g. Prayer Meeting, Baptism Service..."
          ...
          <div>
            ...
            <p className="text-xs text-gray-400 mt-1.5">
              Inactive types won't appear in the Event Type dropdown for new events.
            </p>
          </div>
        </div>
